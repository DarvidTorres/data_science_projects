...
clf.save_model(xgb_model_finalized, "BONUS_SHINY_APP_1/models/xgb_model_finalized")

clf.save_model(lgb_model_finalized, "BONUS_SHINY_APP_1/models/lgb_model_finalized")
